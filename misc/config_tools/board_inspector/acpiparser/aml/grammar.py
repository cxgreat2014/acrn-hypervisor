...
ConnectFieldDef = [
    "NameString"
]  # FIXME: ACPI spec allows "BufferData" here but does not define what "BufferData" is
ConnectField = (AML_CONNECT_FIELD_PREFIX, "ConnectFieldDef")

DefCreateBitField = (AML_CREATE_BIT_FIELD_OP,
                     "SourceBuff", "BitIndex", "NameString")
SourceBuff = ["TermArg"]
BitIndex = ["TermArg"]
DefCreateByteField = (AML_CREATE_BYTE_FIELD_OP,
...
DefCreateWordField = (AML_CREATE_WORD_FIELD_OP,
                      "SourceBuff", "ByteIndex", "NameString")
...
DefMethod = (AML_METHOD_OP, "PkgLength",
             "NameString", "MethodFlags", "TermList")
MethodFlags = ["ByteData"]

DefMutex = (AML_MUTEX_OP, "NameString", "SyncFlags")
SyncFlags = ["ByteData"]

DefOpRegion = (AML_REGION_OP, "NameString",
...
ExtendedAccessField = (
    AML_EXTENDED_ACCESS_FIELD_PREFIX,
    "AccessType",
...
DefConcatRes = (AML_CONCAT_RES_OP, "BufData:BufData1",
                "BufData:BufData2", "Target")
BufData = ["TermArg"]
...
DefLoadTable = (
    ...
    "TermArg:TableID",
    "TermArg:RootPath",
    "TermArg:ParameterPath",
    "TermArg:ParameterData",
)
...
DefMatch = (
    AML_MATCH_OP,
    "SearchPkg",
    "MatchOpcode:MatchOpcode1",
    "Operand:Operand1",
    "MatchOpcode:MatchOpcode2",
    "Operand:Operand2",
    "StartIndex",
)
SearchPkg = ["TermArg"]
...
DefMultiply = (AML_MULTIPLY_OP, "Operand:LeftOperand",
               "Operand:RightOperand", "Target")

DefNAnd = (AML_NAND_OP, "Operand:LeftOperand",
           "Operand:RightOperand", "Target")
...
ObjectTypeContent = ["SimpleName", "DebugObj",
...
DefSubtract = (AML_SUBTRACT_OP, "Operand:LeftOperand",
               "Operand:RightOperand", "Target")
